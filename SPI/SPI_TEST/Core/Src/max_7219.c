...
//int value converted to hex values
//MAX7219_DisplayNumber in this function
...
{
    MAX7219_Send(1, SEG_T);
    MAX7219_Send(2, digitTable[(temp/100)%10]);
    MAX7219_Send(3, digitTable[(temp/10)%10]);
    MAX7219_Send(4, digitTable[temp%10]);

}

//custom values eg.: counter
